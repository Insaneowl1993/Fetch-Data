[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=13275303&assignment_repo_type=AssignmentRepo)
<br/>
<br/>
...
Similar to the previous templating labs, use **BOOTSTRAP CARDS** and grids to arrange the returned post data from JSON Placeholder on the page.


> NOTE: Make use of the fetch API to retrieve data online and display it. Set the limit default to 10. When the page loads up, it will use the default value.
